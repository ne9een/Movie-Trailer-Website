      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header col-md-6">
                ...
                src="https://thegothamrogue.files.wordpress.com/2014/01/movies_logo.gif"
                alt="Movie logo" width="120" height="80" vspace="10">
            </div>
            <div class="col-md-6 text-right text-uppercase">
                <h2 class="title-super text-thin"><font color="white">
                Negin Asghari </font></h2>
...
movie_tile_content = '''
    <div class="col-md-3 movie-tile text-left"
    data-trailer-youtube-id="{trailer_youtube_id}"
    data-toggle="modal" data-target="#trailer ">
        <img src="{poster_image_url}" width="220" height="342">
        <h4> <strong>{movie_title} </strong></h4>
        <div> <h4 class="text-left" data-toggle="modal"
        data-target="trailer">{movie_storyline}</h4></div>
    </div>
'''
